	...
	<body>
		...
		<form method="post" action="<c:url value="update?id=" /><c:out value="${ candidate.id }"/>">
			<fieldset>
				...
				<input type="text" id="lastName" name="lastName" value="<c:out value="${ candidate.lastName }"/>" size="20" maxlength="50" required />
				<span class="error">${form.errors['lastName']}</span>
				<br />
				
				<label for="firstName">Prénom<span class="required">*</span></label>
				<input type="text" id="firstName" name="firstName" value="<c:out value="${ candidate.firstName }"/>" size="20" maxlength="50" required />
				...
				<input type="text" id="livesAt" name="livesAt" value="<c:out value="${ candidate.livesAt }"/>" size="30" maxlength="100" />
				<span class="error">${form.errors['livesAt']}</span>
				<br />
				
				<label for="street">Rue</label>
				<input type="text" id="street" name="street" value="<c:out value="${ candidate.street }"/>" size="30" maxlength="100" />
				<span class="error">${form.errors['street']}</span>
				
				<label for="numStreet">Numéro Rue</label>
				<input type="text" id="numStreet" name="numStreet" value="<c:out value="${ candidate.numStreet }"/>" size="5" maxlength="10" />
				<span class="error">${form.errors['numStreet']}</span>
				<br />
				
				<label for="postCode">Code postal (chiffres uniquement)</label>
				<input type="number" id="postCode" name="postCode" value="<c:out value="${ candidate.postCode }"/>" size="5" maxlength="10" />
				<span class="error">${form.errors['postCode']}</span>
				<br />
				
				<label for="locality">Localité</label>
				<input type="text" id="locality" name="locality" value="<c:out value="${ candidate.locality }"/>" size="20" maxlength="50" />
				<span class="error">${form.errors['locality']}</span>
				<br />
				
				<label for="country">Pays</label>
				<input type="text" id="country" name="country" value="<c:out value="${ candidate.country }"/>" size="20" maxlength="50" />
				<span class="error">${form.errors['country']}</span>
				<br />
				
				<label for="requestDate">Date de demande (format jj.mm.aaaa)</label>
				<input type="date" id="requestDate" name="requestDate" value="<c:out value="${ candidate.getRequestDateFormFormatted() }"/>" size="20" maxlength="50" />
				<span class="error">${form.errors['requestDate']}</span>
				<br />
				
				<label for="initials">Initiales auteur<span class="required">*</span></label>
				<input type="text" id="initials" name="initials" value="<c:out value="${ candidate.initials }"/>" size="10" maxlength="10" required />
				<span class="error">${form.errors['initials']}</span>
				<br />
				
				<label for="jobFunction">Job<span class="required">*</span></label>
				<input type="text" id="jobFunction" name="jobFunction" value="<c:out value="${ candidate.jobFunction }"/>" size="20" maxlength="50" required />
