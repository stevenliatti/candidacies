	...
	<body>
		<form method="post" action="inscription">
			<fieldset>
				...
				<input type="text" id="last_name" name="last_name" value="" size="20" maxlength="50" />
				<br />
				...
				<label for="job_type">Titre<span class="required">*</span></label>
				...
				<label for="job_function">Titre<span class="required">*</span></label>
				<select>
					<option value="infirmier">Volvo</option>
					<option value="animateur">Saab</option>
					<option value="cuisinier">Mercedes</option>
				</select>
