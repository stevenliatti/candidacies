			...
			<fieldset>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<input class="form-control" type="text" id="lastName" name="lastName" value="<c:out value="${empty form.errors ? '' : candidate.lastName }"/>" size="20" maxlength="50" required />
						<span class="error">${form.errors['lastName']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="firstName">Prénom<span class="required">*</span></label>
						<input class="form-control" type="text" id="firstName" name="firstName" value="<c:out value="${empty form.errors ? '' : candidate.firstName }"/>" size="20" maxlength="50" required />
						<span class="error">${form.errors['firstName']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="email">Email</label>
						<input class="form-control" type="email" id="email" name="email" value="<c:out value="${empty form.errors ? '' : candidate.email }"/>" size="30" maxlength="100" />
				...
				<div class="row">
					<div class="col-md-4">
						...
						<input class="form-control" type="text" id="livesAt" name="livesAt" value="<c:out value="${empty form.errors ? '' : candidate.livesAt }"/>" size="30" maxlength="100" />
						<span class="error">${form.errors['livesAt']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="street">Rue</label>
						<input class="form-control" type="text" id="street" name="street" value="<c:out value="${empty form.errors ? '' : candidate.street }"/>" size="30" maxlength="100" />
						<span class="error">${form.errors['street']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="numStreet">Numéro Rue</label>
						<input class="form-control" type="text" id="numStreet" name="numStreet" value="<c:out value="${empty form.errors ? '' : candidate.numStreet }"/>" size="5" maxlength="10" />
				...
				<div class="row">
					<div class="col-md-4">
						...
						<input class="form-control" type="number" id="postCode" min="0" name="postCode" value="<c:out value="${empty form.errors ? '' : candidate.postCode }"/>" size="5" maxlength="10" />
						<span class="error">${form.errors['postCode']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="locality">Localité</label>
						<input class="form-control" type="text" id="locality" name="locality" value="<c:out value="${empty form.errors ? '' : candidate.locality }"/>" size="20" maxlength="50" />
						<span class="error">${form.errors['locality']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="country">Pays</label>
						<input class="form-control" type="text" id="country" name="country" value="<c:out value="${empty form.errors ? '' : candidate.country }"/>" size="20" maxlength="50" />
				...
				<div class="row">
					<div class="col-md-4">
						...
						<input class="form-control" type="date" id="requestDate" name="requestDate" value="<c:out value="${empty form.errors ? '' : candidate.getRequestDateFormFormatted() }"/>" size="20" maxlength="50" />
						<span class="error">${form.errors['requestDate']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="initials">Initiales auteur<span class="required">*</span></label>
						<input class="form-control" type="text" id="initials" name="initials" value="<c:out value="${empty form.errors ? '' : candidate.initials }"/>" size="10" maxlength="10" required />
						<span class="error">${form.errors['initials']}</span>
					</div>
					
					<div class="col-md-4">
						<label for="jobFunction">Job<span class="required">*</span></label>
						<input class="form-control" type="text" id="jobFunction" name="jobFunction" value="<c:out value="${empty form.errors ? '' : candidate.jobFunction }"/>" size="20" maxlength="50" required />
